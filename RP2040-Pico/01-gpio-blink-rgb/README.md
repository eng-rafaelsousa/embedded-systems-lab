...
## 📂 Estrutura do Código
- `blink.c`: Lógica principal com inicialização e loop de alternância de estados.
- `CMakeLists.txt`: Configuração de compilação para o braço de ferramentas ARM GCC.
